...
(function (argument) {
    ...
    if (!window.apiUrl) {
        ...
        //]);
        resources = resources.concat([
            window.path + 'dojo/resources/dojo.css',
            window.path + 'dijit/themes/claro/claro.css',
            //window.path + 'dojox/grid/resources/claroGrid.css',
            window.path + 'dojo/dojo.js',
            window.path + 'jimu.js/css/jimu.css'
        ]);


        if (window.apiUrl.substr(window.apiUrl.length - 'arcgis-js-api/'.length, 'arcgis-js-api/'.length) === 'arcgis-js-api/') {
            ...
            //];
            //
            //resources.push(window.path + 'dojo/dojo.js');
        } else {
            dojoConfig.baseUrl = window.path + 'dojo';
            dojoConfig.packages = [{
                name: "widgets",
