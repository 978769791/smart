define([
	...
	var exports = {
		// summary:
		//		HTML serialization utility s used by editor
	};
	lang.setObject("dijit._editor.html", exports);

	var escape = exports.escapeXml = (/*String*/ str, /*Boolean?*/ noSingleQuotes){
		// summary:
	...
	exports.getNodeHtml = (/*DomNode*/ node){
		// summary:
	...
	exports.getNodeHtmlHelper = (/*DomNode*/ node, /*String[]*/ output){
		// summary:
	...
	exports.getChildrenHtml = (/*DomNode*/ node){
		// summary:
	...
	exports.getChildrenHtmlHelper = (/*DomNode*/ dom, /*String[]*/ output){
		// summary:
