define([
	...
	var TimePicker = declare("dijit._TimePicker", [_WidgetBase, _ListMouseMixin], {
		...
		_showText: function(){
			...
			this._refDate.setFullYear(2016, 4, 30); // match parse defaults
		...
		_createOption: function(/*Number*/ index){
			...
			if(this.constraints.selector == "time"){
				date.setFullYear(2016, 4, 30); // make sure each time is for the same date
			}
