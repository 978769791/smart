...
define([
  ...
  var clazz = declare([_WidgetBase, _TemplatedMixin], {
    ...
    /****these properties can be configured (be overrided) in app's configbak.json*****/
    //id: String
    ...
    //uir: String
    //    used in the configbak.json to locate where the widget is
    uri: undefined,
    ...
    //    config info in configbak.json, url or json object
    //    if url is configured in the configbak.json, json file is parsed and stored in this property
    config: undefined,
    ...
    constructor: function(){
      ...
      //    this property can be set in configbak.json
