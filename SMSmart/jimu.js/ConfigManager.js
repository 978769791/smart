...
function (declare, lang, array, dojoKernel, dojoConfig, topic, aspect, i18n, cookie,
  Deferred, all, xhr, script, require, jimuUtils, WidgetManager, AppVersionManager
     ) {
  ...
  clazz = declare(null, {
    ...
    * ?config=<abc-configbak.json>, this is a config file url
    ...
    * ?appid=<123>, the appid is portal/AGOL app id, which is created from portal/AGOL template.
        ...
        How to check whether the app is in portal?
          ...
          <app>/configbak.json file. If the app is in XT, the portalUrl in configbak.json is not empty.
    ...
    ********************************************************/
    loadConfig: function () {
      ...
      def.then(lang.hitch(this, function(appConfig) {
        ...
        if(this.urlParams.id||appConfig.map.itemId==""){
